    ...
    return (
        <div className="max-w-2xl mx-auto p-4 sm:p-6 space-y-4 sm:space-y-6">
            ...
            <div className="flex items-center space-x-3 mb-4 sm:mb-6">
                <div className="w-12 h-12 sm:w-10 sm:h-10 bg-gradient-to-br from-green-500 to-emerald-600 rounded-lg flex items-center justify-center">
                ...
                <div>
                    ...
                    <p className="text-sm sm:text-base text-gray-600">Configure Google Gemini for invoice analysis</p>
                </div>
            </div>
                ...
                <div className="space-y-4 sm:space-y-6">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full pl-4 pr-12 py-4 text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent touch-manipulation"
                            />
                            <button
                                type="button"
                        ...
                        <div className="mt-2 p-3 bg-gray-50 rounded-lg border">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <button
                                    ...
                                    className="relative px-3 py-1 bg-green-600 text-white text-xs rounded hover:bg-green-700 transition-colors touch-manipulation flex items-center gap-1"
                                >
                                    <Copy size={12} />
                                    Copy
                                </button>
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-4">
                        ...
                        <button
                            ...
                            className="flex items-center justify-center space-x-2 px-6 py-4 bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors touch-manipulation text-base font-medium"
                        >
                            <Save size={18} />
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 sm:p-6">
                <h4 className="font-medium text-blue-900 mb-3 flex items-center space-x-2">
                    ...
                    <span>How AI is used in MasterStocks</span>
                </h4>
                <ul className="text-sm text-blue-800 space-y-2">
                    <li className="flex items-start space-x-2">
                        <span className="text-blue-600">•</span>
                        <span>Analyze invoice images to extract product information</span>
                    </li>
                    <li className="flex items-start space-x-2">
                        <span className="text-blue-600">•</span>
                        <span>Automatically detect product names, quantities, and prices</span>
                    </li>
                    <li className="flex items-start space-x-2">
                        <span className="text-blue-600">•</span>
                        <span>Extract supplier information and invoice details</span>
                    </li>
                    <li className="flex items-start space-x-2">
                        <span className="text-blue-600">•</span>
                        <span>Import data directly into your inventory system</span>
                    </li>
                </ul>
            </div>
        </div>
